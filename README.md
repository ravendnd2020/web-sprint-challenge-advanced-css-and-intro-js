...
Accessibility is the ability of webpages to adapt to different screen sizes and creation of services for access to those with disabilities.
2. Talk about 3 different things you can do to ensure your website is accessible. 
Media queries, use responsive layouts, scalable units not static.
3. How would you explain the concept of a variable to someone new to programming?
data container
4. What is the purpose of using functions in code?
to automate a process and lighten the code load.
